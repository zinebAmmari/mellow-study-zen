...
//   // RÉCUPÉRATION: Lire les minutes d'étude du localStorage
//   const [totalStudyMins] = useLocalStorage("studyMins", 0);
...
//           />
//           {/* AFFICHAGE: Utiliser totalStudyMins et changer le titre */}
//           <StatsCard
//             title="Study Mins"
//             value={`${totalStudyMins}m`}
//             icon={TrendingUp}
//             gradient="bg-accent"
//           />
//         </div>
...
//               />
//               <Button onClick={addDailyGoal} size="sm">
//                 Add
//               </Button>
//             </div>
//           </Card>
...
const Index = () => {
  ...
  // RÉCUPÉRATION: Lire les minutes d'étude du localStorage
  const [totalStudyMins] = useLocalStorage("studyMins", 0);
  // AJOUT: Récupérer les notes du localStorage
  ...
  // AJOUT: Calculer le nombre total de notes
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <StatsCard
            ...
            gradient="gradient-success"
          />
          {/* MODIFICATION: Remplacer la valeur 0 par totalNotes */}
          <StatsCard
            title="Notes"
            value={totalNotes}
            icon={BookOpen}
